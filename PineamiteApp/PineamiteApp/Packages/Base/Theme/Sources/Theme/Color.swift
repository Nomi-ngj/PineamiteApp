...
public extension Color {
    // MARK: - Pill Background Colors
    static let namePillPrimaryTint = Color(.namePillPrimaryTint)
    static let namePillSecondaryTint = Color(.namePillSecondaryTint)
    static let namePillText = Color(.namePillText)

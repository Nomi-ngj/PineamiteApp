 ...
 */
fileprivate let familyName = "Kuunari"
...
public struct Typography {
    ...
    public let title2Bold = AppFont.bold.swiftUIFont(28)
    /// Title 3 font.
    ...
    public let subhead2 = AppFont.medium.swiftUIFont(16)
    /// Footnote font.
    public let footnote = AppFont.regular.swiftUIFont(15)
    /// Footnote medium font.
    public let footnoteMedium = AppFont.medium.swiftUIFont(15)
    public let footnoteBold = AppFont.bold.swiftUIFont(15)
    /// Caption 1 font.
    public let caption1 = AppFont.regular.swiftUIFont(14)
    public let caption1Med = AppFont.medium.swiftUIFont(14)
    public let caption1Bold = AppFont.bold.swiftUIFont(14)
    /// Caption 2 font.
    public let caption2 = AppFont.regular.swiftUIFont(13)
    public let caption2Med = AppFont.medium.swiftUIFont(13)
    public let caption2Bold = AppFont.bold.swiftUIFont(13)
    /// Caption 3 font.
    public let caption3 = AppFont.medium.swiftUIFont(12)
    public let caption3Reg = AppFont.regular.swiftUIFont(12)
    public let caption4 = AppFont.medium.swiftUIFont(10)
    public let caption5 = AppFont.medium.swiftUIFont(8)
    /// Text field font.
    public let textField = AppFont.regular.swiftUIFont(16)
    /// Bold title font.
    public let titleBold = AppFont.bold.swiftUIFont(34)
    /// Medium title 2 font.
    public let title2medium = AppFont.medium.swiftUIFont(24)
    /// Medium title 3 font.
    public let title3medium = AppFont.medium.swiftUIFont(22)
    /// Medium callout font.
    public let calloutMedium = AppFont.medium.swiftUIFont(18)
    ...
    public let subHeadlineMedium = AppFont.medium.swiftUIFont(17)
